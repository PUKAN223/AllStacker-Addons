import { ShutdownBeforeEventSignal, ShutdownEvent, StartupBeforeEventSignal, StartupEvent, SystemBeforeEvents, WorldLoadAfterEvent } from "@minecraft/server";
import PluginSetting from "../types/PluginSetting";
