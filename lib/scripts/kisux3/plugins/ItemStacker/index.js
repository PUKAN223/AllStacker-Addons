...
class ItemStacker extends PluginBase {
    ...
    addConfig(pl, page, showUI = true) {
        ...
        const optionsConfig = {
            "Stacking Settings": () => {
                ...
                unStackPage.addButton(LanguageContext.getTranslation("allstacker.button.add_unstacked", pl), "textures/ui/icon_book_writable", () => {
                    ...
                    Object.entries(itemList).forEach(([name, item]) => {
                        ...
                        if (!item || !item.typeId)
                            return;
                        if ((_a = this.config.ItemStackConfig.get("UnStackItem")) === null || _a === void 0 ? void 0 : _a.includes(item.typeId))
                            return;
            ...
            "Advanced Settings": () => {
                ...
                const isEnable = ((_a = PluginLoader.find(plugin => plugin.name === this.name)) === null || _a === void 0 ? void 0 : _a.setting.enabled) || false;
                ...
                advandSetting.addCallback((values, canceled) => {
                    ...
                    const oldEnable = ((_a = PluginLoader.find(plugin => plugin.name === this.name)) === null || _a === void 0 ? void 0 : _a.setting.enabled) || false;
    ...
    onItemRemoved(ev) {
        if (ev.removedEntity.typeId !== "minecraft:item" ||
