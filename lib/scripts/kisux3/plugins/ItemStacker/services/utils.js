...
export function deStackItemStack(config, itemRemovedData) {
    try {
        ...
        if (itemToSpawn > 0) {
            ...
            const enBase = world.getDimension(itemRemovedData.dim).spawnItem(itemStackSpawn, Object.assign(Object.assign({}, itemRemovedData.location), { y: itemRemovedData.location.y + 100 }));
