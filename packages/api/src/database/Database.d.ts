...
declare class JsonDatabase extends DynamicDatabase{ constructor(id: string, source?: World | Entity ); }
declare interface DynamicProxyConstructor{
    // deno-lint-ignore no-explicit-any
...
declare interface Deserializer<T> extends Generator<T,void,unknown>{
    continue(): T,
...
export declare function registryAPISerializers(): void;
