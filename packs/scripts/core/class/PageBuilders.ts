...
import IMessageForm from "./forms/IMessageForm.ts";
...
class PageBuilder {
  ...
  public addPage(
    pageId: string,
    uiBuilder: IActionForm | IMessageForm | IModalForm,
  ) {
  ...
  public getPage(
    pageId: string,
  ): IActionForm | IMessageForm | IModalForm | undefined {
  ...
  public getPages(): {
    [key: string]: IActionForm | IMessageForm | IModalForm;
  } {
    return this.pages;
  }
