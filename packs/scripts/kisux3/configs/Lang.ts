...
KXEvents.on(null, "after:worldLoad", () => {
  ...
  LanguageContext.setLanguage("en", {
    "allstacker.toggle.fast_mode_stacking": () => "§cOFF§7/§aON §rFast Mode Stacking§r",
    "allstacker.message.fast_mode_stacking.changed": () => "§aFast Mode Stacking§r changed to: %value",
    "allstacker.title.configmenu": () => "§8All Stackers Settings",
    "allstacker.body.configmenu": (pl: Player) => `Hello, §e${pl.name}§r!\n\nThis is the configuration menu.\nYou can manage settings here.`,
    ...
    "allstacker.message.language.set.english": () => `§7[All Stacker] §rLanguage set to §aEnglish§r.`,
    "allstacker.message.language.set.thai": () => `§7[All Stacker] §rLanguage set to §aไทย§r.`,
    ...
    "allstacker.label.itemstacker.description": () => "§aCan§7 add, remove, view §cunstacked items§r.",
    "allstacker.button.stacking_settings": () => "Stacking Settings",
    "allstacker.button.advanced_settings": () => "Advanced Settings",
    "allstacker.label.advanced.description": () => "§aCan§7 §2on§7/§coff§r and adjust the radius for seeing items, display text, and more.",

    // Unstacked Items
    "allstacker.title.unstacked": () => "§8Unstacked Items",
    "allstacker.body.unstacked": () => "Manage the items that are not stacked.",
    "allstacker.label.unstacked": () => "§aCan§7 add, remove, view §cunstacked items§r.",
    ...
    "allstacker.message.unstacked.added": () => `§aAdded§r %name to unstacked items.`,
    ...
    "allstacker.message.unstacked.removed": () => `§cRemoved§r %name from unstacked items.`,
    ...
    "allstacker.textfield.display_text": () => "§7Display Text§r\n %%a§7 - show amount§r\n %%n §7- show name§r\n %%m §7- show minutes§r\n %%s §7- show seconds§r\n %%l §7- new line§r",
    "allstacker.textfield.display_text.placeholder": () => "Customize the text displayed for stacked items.",

    // Messages
    "allstacker.message.display_text.changed": () => "§aDisplay text changed to: %value",
    "allstacker.message.radius_seeing.changed": () => "§aRadius to seeing items§r changed to: %value",
    "allstacker.message.radius_combine.changed": () => "§aRadius to combine items§r changed to: %value",
    "allstacker.message.plugin.enabled": () => "§aItemStacker plugin is now enabled!",
    "allstacker.message.plugin.disabled": () => "§aItemStacker plugin is now disabled!",
    ...
    "allstacker.label.mobstacker.description": () => "§aCan§7 add, remove, view §bstacked mobs§r.",
    "allstacker.button.mobstacker_settings": () => "Stacking Settings",
    "allstacker.label.mobstacker.advanced.description": () => "§aCan§7 §2on§7/§coff§r and adjust the radius of stacking, display text of stacked mobs, and more.",
    ...
    "allstacker.label.no_stackable_mobs": () => "§cNo stackable mobs found in the radius.",
    "allstacker.message.mob.added": () => "§aAdded %name to the stackable mobs.",
    ...
    "allstacker.message.mob.removed": () => "§aRemoved %name from the stackable mobs.",
    ...
    "allstacker.textfield.mob_display_text": () => "§7Display Text\n §r%%a §7- show amount\n§r %%n §7- show name\n §r%%l §7- new line",
    ...
    // MobStacker Messages
    "allstacker.message.mob_death_mode.changed": () => "§aUpdated mob death mode to %value.",
    "allstacker.message.stacking_radius.changed": () => "§aUpdated stacking radius to %value blocks.",
    "allstacker.message.mob_display_text.changed": () => "§aUpdated display text to: %value",
    "allstacker.message.mobstacker.enabled": () => "§aMob Stacker plugin is now enabled.",
    "allstacker.message.mobstacker.disabled": () => "§aMob Stacker plugin is now disabled."
  })
  LanguageContext.setLanguage("th", {
    "allstacker.toggle.fast_mode_stacking": () => "§cปิด§7/§aเปิด §rFast Mode Stacking§r",
    "allstacker.message.fast_mode_stacking.changed": () => "§aFast Mode Stacking§r เปลี่ยนเป็น: %value",
    ...
    "allstacker.message.language.set.english": () => `§7[All Stacker] §rเปลี่ยนภาษาเป็น §aEnglish§r.`,
    "allstacker.message.language.set.thai": () => `§7[All Stacker] §rเปลี่ยนภาษาเป็น §aไทย§r.`,
    ...
    "allstacker.label.itemstacker.description": () => "§aสามารถ§7 เพิ่ม, ลบ, ดู §cไอเท็มที่ไม่รวม§r.",
    "allstacker.button.stacking_settings": () => "การตั้งค่าการรวม",
    "allstacker.button.advanced_settings": () => "การตั้งค่าขั้นสูง",
    "allstacker.label.advanced.description": () => "§aสามารถ§7 §2เปิด§7/§cปิด§r และปรับระยะการมองเห็นไอเท็ม, ข้อความแสดงผล และอื่นๆ",

    // Unstacked Items
    "allstacker.title.unstacked": () => "§8รายการที่ไม่ถูกจัดเรียง",
    "allstacker.body.unstacked": () => "จัดการรายการที่ไม่ถูกจัดเรียง.",
    "allstacker.label.unstacked": () => "§aสามารถ§7 เพิ่ม, ลบ, ดู §cรายการที่ไม่ถูกจัดเรียง§r.",
    ...
    "allstacker.message.unstacked.added": () => `§aเพิ่ม§r %name ลงในรายการที่ไม่ถูกจัดเรียง.`,
    ...
    "allstacker.message.unstacked.removed": () => `§cลบ§r %name ออกจากรายการที่ไม่ถูกจัดเรียง.`,
    ...
    "allstacker.textfield.display_text": () => "§7ข้อความแสดงผล§r\n %%a§7 - แสดงจำนวน§r\n %%n §7- แสดงชื่อ§r\n %%m §7- แสดงนาที§r\n %%s §7- แสดงวินาที§r\n %%l §7- บรรทัดใหม่§r",
    "allstacker.textfield.display_text.placeholder": () => "ปรับแต่งข้อความที่แสดงสำหรับไอเท็มที่รวมกัน.",

    // Messages
    "allstacker.message.display_text.changed": () => "§aเปลี่ยนข้อความแสดงผลเป็น: %value",
    "allstacker.message.radius_seeing.changed": () => "§aเปลี่ยนระยะการมองเห็นไอเท็ม§r เป็น: %value",
    "allstacker.message.radius_combine.changed": () => "§aเปลี่ยนระยะการรวมไอเท็ม§r เป็น: %value",
    "allstacker.message.plugin.enabled": () => "§aเปิดใช้งานปลั๊กอิน ItemStacker แล้ว!",
    "allstacker.message.plugin.disabled": () => "§aปิดใช้งานปลั๊กอิน ItemStacker แล้ว!",

    // MobStacker Main Settings
    "allstacker.title.mobstacker": () => "§8การตั้งค่าการรวมมอบ",
    "allstacker.body.mobstacker": () => "กำหนดค่าปลั๊กอิน Mob Stacker.",
    "allstacker.label.mobstacker.description": () => "§aสามารถ§7 เพิ่ม, ลบ, ดู §bมอบที่รวมกัน§r.",
    "allstacker.button.mobstacker_settings": () => "การตั้งค่าการรวม",
    "allstacker.label.mobstacker.advanced.description": () => "§aสามารถ§7 §2เปิด§7/§cปิด§r และปรับระยะการรวม, ข้อความแสดงผลของมอบที่รวมกัน และอื่นๆ",
    ...
    "allstacker.textfield.mob_display_text": () => "§7ข้อความแสดงผล\n §r%%a §7- แสดงจำนวน\n§r %%n §7- แสดงชื่อ\n §r%%l §7- บรรทัดใหม่",
    ...
    // MobStacker Messages
    "allstacker.message.mob_death_mode.changed": () => "§aอัปเดตโหมดการตายของมอบเป็น %value.",
    "allstacker.message.stacking_radius.changed": () => "§aอัปเดตระยะการรวมเป็น %value บล็อก.",
    "allstacker.message.mob_display_text.changed": () => "§aอัปเดตข้อความแสดงผลเป็น: %value",
    "allstacker.message.mobstacker.enabled": () => "§aปลั๊กอิน Mob Stacker เปิดใช้งานแล้ว.",
    "allstacker.message.mobstacker.disabled": () => "§aปลั๊กอิน Mob Stacker ปิดใช้งานแล้ว."
  });
