import { Entity, EntityRemoveBeforeEvent, EntitySpawnAfterEvent, ItemStack, Player, system, world, WorldLoadAfterEvent } from "npm:@minecraft/server@2.3.0";
import { JsonDatabase, KXEvents, PageBuilder, PluginBase } from "../../../core/index.ts";
import { deStackItemStack, FastModeStacking, SeeingItem, StackingItem } from "./services/utils.ts";
